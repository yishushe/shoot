...
var provice = [
    ...
    },
    {
        ...
        city: [
            ...
            {
                name: "吉安市",
                districtAndCounty: ["吉州区", "吉州区", "井冈山市", "厦坪镇", "吉安县", "敦厚镇", "吉水县", "文峰镇", "峡江县", "水边镇", "新干县", "金川镇", "永丰县", "恩江镇", "泰和县", "澄江镇", "遂川县", "泉江镇", "万安县", "芙蓉镇", "安福县", "平都镇", "永新县", "禾川镇"]
            }
        ]
    },
    {
        ...
        city: [
            {
                name: "济南市",
                districtAndCounty: ["市中区", "历下区", "槐荫区", "天桥区", "历城区", "长清区", "章丘市", "平阴县", "平阴县", "济阳县", "济阳镇", "商河县"]
            },
            {
                name: "青岛市",
    ...
    },
    {
        ...
        city: [
            ...
            {
                name: "济源市",
                districtAndCounty: ["双桥街道","济水街道","北海街道","天坛街道"]
            }
        ]
    },
    {
    ...
    },
    {
        ...
        city: [
            ...
            {
                name: "东莞市",
                districtAndCounty: ["莞城区","万江区","南城区","东城区"]
            },
            {
                name: "珠海市",
            ...
            {
                name: "中山市",
                districtAndCounty: ["石岐区","东区","西区","南区"]
            },
            {
                name: "江门市",
    ...
    },
    {
        ...
        city: [
            ...
            {
                name: "遵义市",
                districtAndCounty: ["红花岗区", "汇川区", "赤水市", "仁怀市", "遵义县", "南白镇", "桐梓县", "娄山关镇", "绥阳县", "洋川镇", "正安县", "凤仪镇", "凤冈县", "龙泉镇", "湄潭县", "湄潭县", "余庆县", "白泥镇", "习水县", "东皇镇", "道真仡佬族苗族自治县", "玉溪镇", "务川仡佬族苗族自治县", "都濡镇"]
            },
            {
                name: "安顺市",
    ...
    },
    {
        ...
        city: [
            {
                name: "台北",
                districtAndCounty: ["中正区","万华区","大同区","中山区"]
            },
            {
                name: "高雄",
                districtAndCounty: ["楠梓区","左营区","鼓山区","三民区"]
            },
            {
                name: "台中",
                districtAndCounty: ["中区","东区","南区","西区"]
            },
            {
                name: "花莲",
                districtAndCounty: ["凤林镇","玉里镇"]
            },
            {
                name: "基隆",
                districtAndCounty: ["中山仔屿","桶盘屿"]
            },
            {
                name: "嘉义",
            ...
            {
                name: "金门",
                districtAndCounty: ["烈屿乡","乌丘乡"]
            },
            {
                name: "连江",
                districtAndCounty: ["凤城镇","敖江镇","东湖镇","浦口镇"]
            },
            {
                name: "苗栗",
                districtAndCounty: ["苑里镇","通霄镇","后龙镇","竹南镇"]
            },
            {
                name: "南投",
                districtAndCounty: ["仁和里","南投里","彰仁里","崇文里"]
            },
            {
                name: "澎湖",
                districtAndCounty: ["","","",""]
